...
public class GridManager : MonoBehaviour
{
    ...
    void GridInit()
    {
        if(currentBagShape == null || slotContainer == null || slotContainer == null || slotBox == null)
        {
            Debug.Log("No Objects in GrideManager.cs! (currentBagShape ||  slotContainer || slotPrefab || slotBox)");
            return;
        }
